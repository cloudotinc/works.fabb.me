...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/library/css/style.css', array(), '20180127', 'all' );

		// ie-only style sheet
		wp_register_style( 'bones-ie-only', get_stylesheet_directory_uri() . '/library/css/ie.css', array(), '20180208' );
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '20171203', true );
...
function bones_related_posts() {
	...
	echo '<div class="postlist postlist-m postlist_related cf">';
	global $post;
	...
	if($tags) {
		...
		$args = array(
			...
			'numberposts' => $showcount, /* you can change this to show more */
...
//			}
            $thumbnail_url = get_thumb_url(true);
				?>
			<div class="postlist-item<?php echo $posClass ?> cf">
				...
				<div class="postinfo">
					...
					?>
					<h3 class="title"><?php echo get_title_for_archive(); ?></h3>
				</div>
			</div>
		<?php endforeach; }
	else { ?>
