...
<script>
    ...
    <section id="wo_workers">
        <h2 class="inner">
            <img src="<?php echo $template_url ?>/images/worker/workers_word.png" alt="ワーカー">
        </h2>
    </section>
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <section id="wo_syokai" class="inner">
        ...
        <div id="wo_profie">
            ...
            if (!empty($prevpost)) {
                ?>
                <a href="<?php echo get_permalink($prevpost->ID) ?>"> <img src="<?php echo $template_url ?>/images/worker/left_kakko.png" alt="左カッコ"></a>
                <?php
            } else {
            ?>
                <span class="disable"><img src="<?php echo $template_url ?>/images/worker/left_kakko.png" alt="左カッコ"></span>
            <?php
            }
            ?>
            <div id="wo_prof_box">
            ...
            if (!empty($nextpost)) {
                ?>
                <a href="<?php echo get_permalink($nextpost->ID) ?>"> <img src="<?php echo $template_url ?>/images/worker/right_kakko.png" alt="右カッコ"></a>
                <?php
            } else {
                ?>
                <span class="disable"><img src="<?php echo $template_url ?>/images/worker/right_kakko.png" alt="右カッコ"></span>
                <?php
            }
            ?>
        </div>
                            ...
                            <a href="<?php the_permalink() ?>">
                                ...
                                <div class="wo_se_rightbox">
                                    <ul>
                                        ...
                                        <li class="wo_se36">￥<?php the_field('srv_price') ?></li>
                                        <li class="wo_se18">（税込）</li>
                                    </ul>
